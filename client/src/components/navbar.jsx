  ...
  return (
    <div >
      <nav className="navbar navbar-expand-lg navbar-light bg-warning">
        <img style={{ maxHeight: "100px" }} src="logo.png" alt=""></img>
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          {(!localStorage.getItem("authToken")) ?
            ...
            <div>
              <div className="btn bg-white  mx-1" onClick={()=>{setCartView(true)}}><Badge pill bg="danger" className="">{data.length}</Badge>{" "}<img style={{ maxHeight: "26px" }} src="sc.png" alt="sc"></img></div>
