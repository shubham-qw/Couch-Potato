                    ...
                    <tbody>
                        {
                            data.map((order, index) => {
                                return (<tr key={order.id}>
                                    ...
                                    <td className='text-white'><button type="button" className='btn p-0 bg-white' onClick={() => { dispatch({ type: "remove", index: index }) }}><img src="trash.png" alt="delete"></img></button></td>
                                </tr>
                                )
                            })
                        }
